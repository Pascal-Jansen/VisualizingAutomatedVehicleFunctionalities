...
$filepath = realpath(__DIR__) . "/results/demographic_part1.csv";
...
$videoPath = "/assets/ulm_videos/baseline.mp4";
$videoDescription = "";
if($counterMod2 == 1){
    $videoPath = "/assets/ulm_videos/SIE.mp4";
    ...
    Furthermore, you will be shown both the <b>trajectory</b> ( the probable direction of travel) of your <b>own vehicle</b> and the trajectory of <b>other vehicles</b>. Trajectories are visualized with the help of successive arrows. In addition, trajectories have a <b>color gradient</b>, which ranges from <b>blue to pink</b>. The <b>more blue</b> the color, the <b>more certain</b> the autonomous vehicle is about the predicted trajectory.";
} 
if($counterMod2 == 0) {
    $videoPath = "/assets/ulm_videos/baseline.mp4";
        ...
        <div id="videoDIV">
            ...
            <div class="row g-4 justify-content-center align-items-center">
                <div class="col-md-10 text-center text-md-start pb-3">
                    <p>
                        In the following video, you will see an autonomous car driving in a city.
                    </p>
                    <p>
            ...
            <div class="row justify-content-center my-3" id="videoDiv">
                <div class="col text-center">
                    <div class="ratio ratio-16x9">
                        <video width="1280" height="720" controls autoplay preload="auto" id="video">
...
-->
        <form action="survey_page_two.php" method="post" class="row g-3 needs-validation" id="questionsForm" name="questionsForm" onsubmit="return validateForm()" novalidate style="display: none">

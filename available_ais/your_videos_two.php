<?php
    ...
    fclose($file);
    $timeToContinue = date('Y-m-d H:i:s', strtotime($timeAtUpload . ' + 1 day'));
    #todo: check if files exist already then dont weiterleiten to too_early.php
    ...
    $videoPath = "uploads/" . $prolificID . "/" . $prolificID . "_720p_25_fps.mp4";
    $videoDescription = "";
    if($counterMod2 == 1){
    ...
    <div class="container-md bg-light my-3 py-3">
        <div id="videoDIV">
            <div class="text-center">
                <h1 class="display-2 mb-5">Video 1</h1>
            </div>
...
<!--
        <div class="text-center my-3">
            <a class="btn btn-primary btn-lg" href="survey_page_two.php" role="button">Next</a>
        </div>
-->
        <form action="your_videos_three.php" method="post" class="row g-3 needs-validation" id="questionsForm" name="questionsForm" onsubmit="return validateForm()" novalidate style="display: none">
            ...
            <div class="container text-start">
                ...
                <div class="row justify-content-start">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="TLXQuestion1" id="inlineRadio1" value="1" required>
                            <label class="form-check-label" for="inlineRadio1">1</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="TLXQuestion1" id="inlineRadio2" value="2" required>
                            <label class="form-check-label" for="inlineRadio2">2</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="TLXQuestion1" id="inlineRadio3" value="3" required>
                            <label class="form-check-label" for="inlineRadio3">3</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="TLXQuestion1" id="inlineRadio4" value="4" required>
                            <label class="form-check-label" for="inlineRadio4">4</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="TLXQuestion1" id="inlineRadio5" value="5" required>
                            <label class="form-check-label" for="inlineRadio5">5</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="TLXQuestion1" id="inlineRadio6" value="6" required>
                            <label class="form-check-label" for="inlineRadio6">6</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="TLXQuestion1" id="inlineRadio7" value="7" required>
                            <label class="form-check-label" for="inlineRadio7">7</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="TLXQuestion1" id="inlineRadio8" value="8" required>
                            <label class="form-check-label" for="inlineRadio8">8</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="TLXQuestion1" id="inlineRadio9" value="9" required>
                            <label class="form-check-label" for="inlineRadio9">9</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="TLXQuestion1" id="inlineRadio10" value="10" required>

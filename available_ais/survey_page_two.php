...
<section id="topics">
    ...
    <!--                        <source src="/uploads/ulm_videos/ulm_video_720p_result_od_reconverted.mp4" type="video/mp4">-->
        ...
        -->
        <form action="survey_page_three.php" method="post" class="row g-3 needs-validation" id="questionsForm" name="questionsForm" onsubmit="return validateForm()" novalidate style="display: none">

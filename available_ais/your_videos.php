<?php
if(!isset($_POST["uniqueIDSubmit"]) && !isset($_COOKIE["prolific_id"])){
    header("Location: /your_videos_index.php");
    exit();
}
$uniqueID = "";
if(isset($_POST["uniqueIDSubmit"])){
    $uniqueID = isset($_POST['uniqueIDInput']) ? $_POST['uniqueIDInput'] : '';
    if(isset($_COOKIE["prolific_id"])) {
        unset($_COOKIE['prolific_id']);
    }
    $cookie_name = "prolific_id";
    $cookie_value_unique_id = $uniqueID;
    setcookie($cookie_name, $cookie_value_unique_id, time() + 30 * 86400, "/"); // 86400 = 1 day
}
...
<section id="topics">
    <div class="container-md bg-light">
        <div class="text-center">
            <h1 class="display-2">Your own videos</h1>
        </div>
        ...
        <div id="carouselExampleIndicators" class="carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="15000">
                    <img src="/assets/Video.png" alt="pic1">
                </div>
                <div class="carousel-item" data-bs-interval="15000">
                    <img src="/assets/Fragen.png" alt="pic2">
                </div>
                <div class="carousel-item" data-bs-interval="15000">
                    <img src="/assets/Next.png" alt="pic3">
                </div>
            </div>
        ...
        <form action="your_videos_one.php" method="post" class="row g-3 needs-validation" name="demographicForm" onsubmit="return validateForm()" novalidate>
            <input type="hidden" name="demo_part" id="demo_part" value="2" />
